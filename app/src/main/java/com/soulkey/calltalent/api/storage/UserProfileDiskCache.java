 ...
 */
public class UserProfileDiskCache {

    private final long NO_VALUE = 0L;
    private final String KEY_UID = "userprofile-key-uid";
    private final String KEY_USERNAME = "userprofile-key-username";
    ...
    public Observable<UserProfile> getEntity() {
        return Observable.defer(() -> {
            ...
            result = Observable.just(UserProfile.create(
                    uid, username, name, title, avatarUrl, gender, desc, timestamp));
            return result;
        });
    }
